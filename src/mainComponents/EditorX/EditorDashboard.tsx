...
// Content domains that exist in this project. Routes match the admin manager
// pages confirmed in AdminDash.tsx — there are no separate /editor/* managers.
const NAV_ITEMS: NavItem[] = [
  {
    title: "Photos",
    description: "Upload and organize gallery photos",
    icon: Images,
    route: "/admin/photoDashboard",
    color: "border-l-pink-500",
  },
  {
    title: "Videos",
    description: "Manage the video gallery",
    icon: Video,
    route: "/admin/videoDashboard",
    color: "border-l-red-500",
  },
  {
    title: "Press",
    description: "Manage press articles",
    icon: FileText,
    route: "/admin/pressDashboard",
  ...
  return (
    <div className='min-h-screen bg-gradient-to-br from-slate-50 to-white'>
      ...
      <div className='container py-6 px-4 sm:px-6'>
          ...
          {NAV_ITEMS.map((item) => (
            ...
            >
              <CardContent className='p-4 sm:p-6 flex items-center gap-4'>
                <div className='rounded-lg bg-gray-100 p-3 shrink-0'></div>
                <div className='min-w-0'>
        ...
        <div className='mt-8 flex items-start gap-3 rounded-lg border border-orange-200 bg-orange-50 p-4'>
