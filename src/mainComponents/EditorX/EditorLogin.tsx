...
const EditorLogin: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // editorApi applies transformErrorResponse: handleApiError, so the
      // rejected value is a string. Guard for both shapes defensively.
      const message =
        typeof err === "string"
          ? err
        ...
        <div className='bg-white rounded-xl shadow-sm border p-8'>
          <div className='text-center mb-6'>
            <img
              src={BJP_LOGO}
              alt='Biswajit Phukan'
              className='h-14 w-14 mx-auto object-contain mb-3'
            />
