...
// editorApi applies transformErrorResponse: handleApiError, so a rejected
// mutation/query yields a string. Guard for both shapes defensively.
...
const EditorManager: React.FC = () => {
  ...
  const handleCreate = async () => {
    ...
    try {
      ...
      toast.error(getErrorMessage(err, "Failed to create editor"));
    }
  };
  ...
  const handleResendConfirm = async () => {
    ...
    try {
      ...
      toast.error(getErrorMessage(err, "Failed to resend credentials"));
    } finally {
  ...
  const handleDeleteConfirm = async () => {
    ...
    try {
      ...
      toast.error(getErrorMessage(err, "Failed to delete editor"));
    } finally {
