              ...
              >
                ...
                <div className='p-6 md:p-8'>
                  ...
                  >
                    ...
                    {/* Details Grid */}
                    <div className='grid grid-cols-2 md:grid-cols-3 gap-4 p-4 bg-gray-50 dark:bg-neutral-800 rounded-lg'>
                      ...
                      <div className='text-center'>
                        <div className='h-6 w-6 mx-auto mb-2 bg-[#138808] rounded text-white flex items-center justify-center text-xs font-bold'>
