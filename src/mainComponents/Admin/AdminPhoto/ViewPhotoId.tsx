...
const ViewPhotoId: React.FC = () => {
  ...
  // Extract photo data safely with better type checking
  ...
  // Get related photos by category with better error handling
  const { data: relatedPhotosData, isLoading: isRelatedLoading } =
    useGetPhotosQuery(
      {
        category: categoryInfo?.name || "",
        limit: 9, // Increased to show more related photos
        page: 1,
        sortBy: "createdAt",
        sortOrder: "desc",
      },
  ...
  // Filter out current photo from related photos and limit results
  const relatedPhotos =
    relatedPhotosData?.success && relatedPhotosData.data?.photos
      ? relatedPhotosData.data.photos
          ...
          .slice(0, 6) // Show max 6 related photos
      : [];
        ...
        >
          <Card className='overflow-hidden shadow-xl'>
            <CardContent className='p-0'>
              ...
              {/* Photo Image with Enhanced Slider */}
          ...
          {/* Enhanced Related Photos Section */}
          <motion.div
            initial='hidden'
            animate='visible'
            variants={fadeInVariants}
              ...
              >
                ...
                {photo.images.length > 1 && (
                  <>
                    ...
                    {/* Enhanced counter with thumbnails */}
