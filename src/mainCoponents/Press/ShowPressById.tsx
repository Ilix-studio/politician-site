        ...
        <div className='container flex h-16 items-center justify-between'>
          ...
          <div className='flex items-center gap-2'>
            <button
              onClick={handleShare}
              disabled={isSharing}
              className='inline-flex items-center px-3 py-2 text-sm border border-input bg-background hover:bg-accent hover:text-accent-foreground rounded-md transition-colors disabled:opacity-50'
            >
      ...
      <main className='container py-8 max-w-4xl mx-auto'>
        ...
        <header className='mb-8'>
          ...
          <div className='flex flex-wrap items-center gap-2 mb-4'>
            <span className='px-3 py-1 bg-[#FF9933]/10 text-[#FF9933] rounded-full text-sm font-medium'>
              {article.category}
            </span>
          ...
          <div className='flex flex-wrap gap-3'>
            <button
              onClick={handleShare}
              disabled={isSharing}
              className='inline-flex items-center px-4 py-2 text-sm bg-[#FF9933] text-white rounded-md hover:bg-[#FF9933]/90 transition-colors disabled:opacity-50'
            >
              <Share2 className='mr-2 h-4 w-4' />
            ...
            <a
              ...
              className='inline-flex items-center px-4 py-2 text-sm border border-input bg-background hover:bg-accent hover:text-accent-foreground rounded-md transition-colors'
            >
        ...
        <article className='prose prose-lg max-w-none mb-12'>
          <div
            ...
            className='text-foreground 
              ...
              [&>h3]:text-xl [&>h3]:font-bold [&>h3]:mt-8 [&>h3]:mb-4 [&>h3]:text-[#FF9933]
              [&>ul]:mb-6 [&>ul]:pl-6 [&>li]:mb-2
              [&>blockquote]:border-l-4 [&>blockquote]:border-[#FF9933] [&>blockquote]:pl-4 [&>blockquote]:italic [&>blockquote]:my-6 [&>blockquote]:bg-slate-50 [&>blockquote]:py-4 [&>blockquote]:rounded-r
            ...
            {pressArticles.map((pressArticle) => (
              ...
              >
                ...
                <div className='flex items-center gap-2 text-xs text-muted-foreground'>
                  ...
                  <span>•</span>
                  <span>{pressArticle.source}</span>
                  <span>•</span>
                  <span>{pressArticle.views} views</span>
                </div>
              </button>
            ))}
          </div>
